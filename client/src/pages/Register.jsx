...
import { FaUser, FaEnvelope, FaLock, FaSpinner, FaArrowRight } from 'react-icons/fa';
...
const Register = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#030014] px-4 py-12 sm:px-6 lg:px-8 overflow-hidden font-sans">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-500/10 blur-[120px] pointer-events-none" />
